...
//                          floral (kvetinové), woody (drevité/musk/koža)
...
const products = [
  ...
  },
  {
    ...
    sizes: [{size:"2ml",price:3.5},{size:"5ml",price:9},{size:"10ml",price:17}],
  ...
  },
  {
    ...
    notes: ["Cherry", "Cardamom", "Lavender", "Sage", "Cedarwood", "Amber"],
    types: ["sweet", "spicy"],
    quiz: { sweet: 3, night: 2, loud: 2, universal: 1 },
    desc: "Tá istá tmavá sladká teplosť ako Intensely — len čerešňa pridá ovocný výbuch na otvorení. Šťavnatejšia a odvážnejšia, ale s rovnako teplým, korenistým doznením.",
    sizes: [{size:"2ml",price:3.5},{size:"5ml",price:9},{size:"10ml",price:17}],
  ...
  {
    brand: "Essential Parfums", name: "Divine Vanille", dataBrand: "essential-parfums",
    notes: ["Cinnamon", "Black Pepper", "Osmanthus", "Madagascar Vanilla", "Tonka Bean", "Patchouli"],
    types: ["sweet", "spicy"],
  ...
  },
  {
    ...
    sizes: [{size:"2ml",price:13},{size:"5ml",price:32},{size:"10ml",price:59}],
  ...
  },
  {
    ...
    types: ["fresh"],
    quiz: { fresh: 3, summer: 2, day: 2, universal: 3, loud: 1 },
